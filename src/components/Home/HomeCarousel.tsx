      ...
      {carouselMovies.map((movie, index) => (
        ...
        >
          <div className="relative">
            ...
            <div
              className={
                "w-full absolute h-full top-0 left-0 bg-black opacity-[0.1] hover:opacity-[0.3] transition-opacity duration-200"
              }
            ></div>
          ...
          <div className="absolute bottom-0 flex items-end gap-4 px-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <h2 className="w-[500px] text-xl line-clamp-3 text-zinc-400">
                {movie.overview}
              </h2>
